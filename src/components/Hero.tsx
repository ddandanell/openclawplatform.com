    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center z-10">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white leading-tight mb-6 max-w-5xl mx-auto">
          AI Agents That Work, <span className="gradient-text">Built by Top Engineers</span>
        </h1>
        ...
        <p className="text-xl sm:text-2xl text-[#D0D0DC] max-w-3xl mx-auto mb-4 leading-relaxed">
          We build and deploy AI agents that handle real work—customer support, operations, sales—so you can focus on growth. <strong className="text-[#E8E8F0]">Secure, reliable, and designed for production.</strong>
        </p>
        <p className="text-base sm:text-lg text-[#B0B0C0] max-w-2xl mx-auto mb-6 leading-relaxed">
          Your AI workforce integrates seamlessly, learns continuously, and delivers measurable ROI—with our team managing everything end-to-end.
        </p>
